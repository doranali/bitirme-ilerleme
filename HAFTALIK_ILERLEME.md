...
> **Kullanım:** Aşağıdaki tabloyu projenize göre doldurun. Her hafta için planlanan işi ve o haftanın sonunda projenin tahmini tamamlanma oranını yazın. Dönem ilerledikçe "Durum" sütununu güncelleyin. *(İlk raporlama haftası bir sonraki haftadan itibaren; tarih aralıklarını kendi takviminize göre düzeltin.)*

| Hafta | Tarih Aralığı | Planlanan İş | Tahmini Tamamlanma (%) | Durum |
|-------|---------------|--------------|------------------------|-------|
| 1 | 07.04 - 13.04.2026 | Sistem mimarisi: `docker-compose` topolojisi, ağ ve servis bağımlılıkları; `docs/` ile kurulum–işletme özeti | %42 | ⬜ Başlamadı |
...
> **Kullanım:** Her hafta aşağıdaki şablonu kopyalayıp doldurun. En güncel hafta en üstte olacak şekilde ekleyin. İlk kayıt, takvimdeki **Hafta 1** bittiğinde (Pazar 23:59 öncesi) eklenecek.
